...
//Retorna um array com todos os itens que satisfaçam a condição
...
//Retorna o último indice em que um elemento pode ser encontrado
...
//Verifica se pelo menos um item satisfaz uma condição
console.log(arr.some( value => value % 5 === 0 ));

//Verifica se os elementos satisfazem uma condição
console.log(arr.every(value => value.isNaN)); // false
console.log(arrFind.every( value => value % 1 === 0 )); //true

// Ordena elementos do array de acordo com a condição
